...
<div class="row">
	...
	<div class="col">
			<form class="form-signin" action="${pageContext.request.contextPath }/user/userLogin.do" method="post">
				...
				<input type="text" name="inputID" class="form-control" placeholder="ID" maxlength="16" required autofocus>
					<br> 
				<input type="password" name="inputPassword" class="form-control" placeholder="Password" maxlength="16" required>
					<br>
