...
<body>
	<div class="card" style="width: 100%;">
		<div class="card-header"><strong>설문 페이지 등록</strong></div>
		<ul class="list-group list-group-flush">
			...
			<li class="list-group-item">
				...
				<button type="button" class="btn btn-primary" style="width:150px;" onClick="analBoardAppend();">등록</button>
			</li>
		</ul>
	</div>
</body>
