...
<body>
	<div class="card" style="width: 100%;">
		<div class="card-header"><strong>메뉴 등록</strong></div>
		<input type="hidden" id="a_no" value="">
		<ul class="list-group list-group-flush">
			<li class="list-group-item">
				메뉴 이름 : <input type="text" class="form-control" name="menu_name" id="menu_name" maxlength="20">
			</li>
			<li class="list-group-item">
				메뉴 사용 여부 : 
			...
			<li class="list-group-item">
				...
				<button type="button" class="btn btn-primary" style="width:150px;" onClick="menuAppend();">등록</button>
			</li>
		</ul>
	</div>
</body>
