...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      	<form name="readArticle" id="readArticle" action="" method="post" target="popup_window">
...
<%-- 	      	<a href="#" onclick="document.getElementById('readArticle').submit();">${boardList.board_title }</a> --%>
	      	<a href="#" id="submitLink">${boardList.board_title }</a>
      	</form>
      </td>
...
<script type="text/javascript">
	...
	$('#submitLink').on("click", function() {
		var url = "/multi/testFormArticle.do";
		window.open(url, 'popup_window', 'width=500px, height=500px');
		$('#readArticle').submit();		
	});
</script>
</body>
