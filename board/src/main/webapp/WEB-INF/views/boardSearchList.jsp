		...
		<div class="row">
			...
			<div class="col-11">
				...
				<c:if test="${sessionScope.username ne null }">
					...
					<button type="button" class="btn btn-info" onClick="location.href='${pageContext.request.contextPath }/main.do?page=1'">게시판으로 돌아가기</button>
					</br>
					</br>
  							...
  							<ul class="pagination">
   								 <li class="page-item">
   								 	<c:if test="${param.page ne 1 }">
	    								 <a class="page-link" href="${pageContext.request.contextPath }/boardSearch.do?keyword=${keyword }&page=${param.page-1}" aria-label="Previous">
	     							 	<span aria-hidden="true">&laquo;</span>
	      								 </a>
   								 	</c:if>
    							 </li>
    							 <c:forEach begin="1" end="${totalPage }" var="value">
	    							 <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/boardSearch.do?keyword=${keyword }&page=${value }">${value }</a></li>						 
    							 </c:forEach>
    							 <li class="page-item">
    							 <c:if test="${param.page ne totalPage }">
     							 	<a class="page-link" href="${pageContext.request.contextPath }/boardSearch.do?keyword=${keyword }&page=${param.page+1}" aria-label="Next">
