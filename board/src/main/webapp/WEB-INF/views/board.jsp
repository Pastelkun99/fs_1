...
<body>
	...
	<div class="row">
		...
		<div class="col-xs-8 col-md-8">
			...
			<!-- 현재 로그인 된 사람의 아이디 -->
			<input type="hidden" id="current_userid" value="${sessionScope.user_id }"/>
			
			<button type="button" class="btn btn-primary" onClick="location.href='${pageContext.request.contextPath }/boardedit.do?boardno=${board.board_no}'">수정하기</button>
			<button type="button" class="btn btn-danger" onClick="location.href='${pageContext.request.contextPath}/boardDelete.do?boardno=${board.board_no}'">삭제하기</button>
			<button type="button" class="btn btn-primary" onClick="location.href='${pageContext.request.contextPath }/main.do?page=1'">목록보기</button>
			<hr>
			</div>
			<div class="row">
				<div class="col-2">
  			...
  			<div id="replyListView">
	  			<c:forEach items="${reply_list}" var="reply_list">
	  				<div class="row">
	  					...
	  					<div class="col-2">		
	  					<c:choose>
	  						<c:when test="${sessionScope.user_id eq reply_list.reply_userid}">
