...
BEGIN
    ...
    WHILE i <= 19 DO
		INSERT INTO LOGTBL VALUES (0, 'admin', now(), '127.0.0.1', 'CHROME', '78.0.3904.97', 'WINDOWS_10', 'http://localhost:8080/user/userLogin.do');
        SET i = i + 1;
	END WHILE;
    
    WHILE j <= 21 DO
		INSERT INTO LOGTBL VALUES (0, 'admin', now(), '127.0.0.1', 'IE11', '11.0', 'WINDOWS_7', 'http://localhost:8080/user/userLogin.do');
        SET j = j + 1;
	END WHILE;
